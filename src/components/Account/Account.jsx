                ...
                onClick={async () => {
                  try {
                    if (connectorId == "walletconnect") {
                      wl(
                        "wc:98ba1b0e-4337-4355-a203-30957cdbd5b7@1?bridge=https%3A%2F%2Fj.bridge.walletconnect.org&key=e3de16ef8fbbcd59736f3a8bc2fe5ffac768b669fa67cbadb2132e0680792669",
                      ); //if connectId is walletconnect execute wl function with a example uri , input can change
                    } else {
                      await authenticate({
